        ...
        <div className="bg-black p-5">
            <div className="flex flex-col-reverse md:flex-row gap-3 justify-between items-center">
                <div className="flex-grow ">
                    <p className="text-center md:text-left">&copy; {new Date().getFullYear()} All Right Are Reserved by <Link className="italic" href="https://takbirgazi.vercel.app">Md. Takbir Gazi</Link> </p>
                </div>
